...
public final class ActivitySportrunninghismapBinding implements ViewBinding {
    ...
    public static ActivitySportrunninghismapBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivitySportrunninghismapBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_sportrunninghismap, parent, false);
        if (attachToParent) {
    ...
    public static ActivitySportrunninghismapBinding bind(View rootView) {
