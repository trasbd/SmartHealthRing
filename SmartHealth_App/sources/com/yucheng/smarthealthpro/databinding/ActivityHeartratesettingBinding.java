...
public final class ActivityHeartratesettingBinding implements ViewBinding {
    ...
    private ActivityHeartratesettingBinding(LinearLayout rootView, ImageView ivInterval, ImageView ivRemind, RelativeLayout llInterval, RelativeLayout llRemind, NavigationBar navigationbar, Switch switchMonitor, Switch switchPolice, TextView tvInterval, TextView tvRemind, View viewInterval) {
    ...
    public static ActivityHeartratesettingBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityHeartratesettingBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_heartratesetting, parent, false);
        if (attachToParent) {
    ...
    public static ActivityHeartratesettingBinding bind(View rootView) {
                                ...
                                if (r10 != null) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (textView2 != null && (viewFindChildViewById = ViewBindings.findChildViewById(rootView, (i2 = R.id.view_interval))) != null) {
                                            return new ActivityHeartratesettingBinding((LinearLayout) rootView, imageView, imageView2, relativeLayout, relativeLayout2, navigationBar, r9, r10, textView, textView2, viewFindChildViewById);
                                        }
                                    }
                                }
                            }
