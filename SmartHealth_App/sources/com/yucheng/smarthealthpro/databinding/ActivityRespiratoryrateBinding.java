...
public final class ActivityRespiratoryrateBinding implements ViewBinding {
    ...
    public static ActivityRespiratoryrateBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityRespiratoryrateBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_respiratoryrate, parent, false);
        if (attachToParent) {
    ...
    public static ActivityRespiratoryrateBinding bind(View rootView) {
                    ...
                    if (viewFindChildViewById4 != null) {
                        ...
                        if (navigationBar != null) {
                            ...
                            if (nestedScrollView != null) {
                                return new ActivityRespiratoryrateBinding((RelativeLayout) rootView, functionItemBottomIncludeBindingBind, functionItemCalendarIncludeBindingBind, functionItemMeasureDataIncludeBindingBind, functionItemTopIncludeBindingBind, navigationBar, nestedScrollView);
                            }
                        }
                    }
                }
