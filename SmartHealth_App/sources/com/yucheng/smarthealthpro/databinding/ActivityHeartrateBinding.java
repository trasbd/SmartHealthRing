...
public final class ActivityHeartrateBinding implements ViewBinding {
    ...
    public static ActivityHeartrateBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityHeartrateBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_heartrate, parent, false);
        if (attachToParent) {
    ...
    public static ActivityHeartrateBinding bind(View rootView) {
                    ...
                    if (viewFindChildViewById4 != null) {
                        ...
                        if (navigationBar != null) {
                            ...
                            if (nestedScrollView != null) {
                                return new ActivityHeartrateBinding((RelativeLayout) rootView, functionItemBottomIncludeBindingBind, functionItemCalendarIncludeBindingBind, functionItemMeasureDataIncludeBindingBind, functionItemTopIncludeBindingBind, navigationBar, nestedScrollView);
                            }
                        }
                    }
                }
