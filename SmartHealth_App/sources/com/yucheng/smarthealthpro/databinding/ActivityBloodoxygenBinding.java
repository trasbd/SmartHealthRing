...
public final class ActivityBloodoxygenBinding implements ViewBinding {
    ...
    public static ActivityBloodoxygenBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_bloodoxygen, parent, false);
        if (attachToParent) {
                    ...
                    if (viewFindChildViewById4 != null) {
                        ...
                        if (navigationBar != null) {
                            ...
                            if (nestedScrollView != null) {
                                return new ActivityBloodoxygenBinding((RelativeLayout) rootView, functionItemBottomIncludeBindingBind, functionItemCalendarIncludeBindingBind, functionItemMeasureDataIncludeBindingBind, functionItemTopIncludeBindingBind, navigationBar, nestedScrollView);
                            }
                        }
                    }
                }
