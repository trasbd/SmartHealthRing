...
public final class LayoutBloodPressureCalibrationSelectorBinding implements ViewBinding {
    ...
    public static LayoutBloodPressureCalibrationSelectorBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LayoutBloodPressureCalibrationSelectorBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.layout_blood_pressure_calibration_selector, parent, false);
        if (attachToParent) {
    ...
    public static LayoutBloodPressureCalibrationSelectorBinding bind(View rootView) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    if (textView3 != null) {
                                                        ...
                                                        if (textView4 != null) {
                                                            ...
                                                            if (textView5 != null) {
                                                                return new LayoutBloodPressureCalibrationSelectorBinding(linearLayout2, linearLayout, linearLayout2, textView, wheelView, wheelView2, wheelView3, linearLayout3, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, textView2, textView3, textView4, textView5);
                                                            }
                                                        }
                                                    }
                                                }
