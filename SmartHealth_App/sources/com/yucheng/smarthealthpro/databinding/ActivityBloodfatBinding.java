...
public final class ActivityBloodfatBinding implements ViewBinding {
    ...
    public static ActivityBloodfatBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityBloodfatBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_bloodfat, parent, false);
        if (attachToParent) {
    ...
    public static ActivityBloodfatBinding bind(View rootView) {
                    ...
                    if (viewFindChildViewById4 != null) {
                        ...
                        if (navigationBar != null) {
                            ...
                            if (nestedScrollView != null) {
                                return new ActivityBloodfatBinding((RelativeLayout) rootView, functionItemBottomIncludeBindingBind, functionItemCalendarIncludeBindingBind, functionItemMeasureDataIncludeBindingBind, functionItemTopIncludeBindingBind, navigationBar, nestedScrollView);
                            }
                        }
                    }
                }
