...
public final class ActivityDevicelistBinding implements ViewBinding {
    ...
    private ActivityDevicelistBinding(LinearLayout rootView, NavigationBar navigationbar, RecyclerView recycleDevicelist, SmartRefreshLayout srlHome) {
        this.rootView = rootView;
        this.navigationbar = navigationbar;
        this.recycleDevicelist = recycleDevicelist;
    ...
    public static ActivityDevicelistBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_devicelist, parent, false);
        if (attachToParent) {
        ...
        if (navigationBar != null) {
            ...
            if (recyclerView != null) {
                ...
                if (smartRefreshLayout != null) {
                    return new ActivityDevicelistBinding((LinearLayout) rootView, navigationBar, recyclerView, smartRefreshLayout);
                }
            }
        }
