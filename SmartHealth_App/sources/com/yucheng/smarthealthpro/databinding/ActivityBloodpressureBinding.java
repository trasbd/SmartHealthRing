...
public final class ActivityBloodpressureBinding implements ViewBinding {
    ...
    public static ActivityBloodpressureBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_bloodpressure, parent, false);
        if (attachToParent) {
                    ...
                    if (viewFindChildViewById4 != null) {
                        ...
                        if (navigationBar != null) {
                            ...
                            if (nestedScrollView != null) {
                                return new ActivityBloodpressureBinding((RelativeLayout) rootView, functionItemBottomIncludeBindingBind, functionItemCalendarIncludeBindingBind, functionItemMeasureDataIncludeBindingBind, functionItemTopIncludeBindingBind, navigationBar, nestedScrollView);
                            }
                        }
                    }
                }
