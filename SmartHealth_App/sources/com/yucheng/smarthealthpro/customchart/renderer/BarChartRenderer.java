...
public class BarChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    public BarChartRenderer(BarDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler, Context context) {
        ...
        if (this.mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i4 = 0; i4 < iMin; i4++) {
                ...
                if (this.mViewPortHandler.isInBoundsLeft(this.mBarShadowRectBuffer.right)) {
                    ...
                    if (Constant.isHeGe() && this.isRoundBar) {
                        c2.drawRoundRect(this.mBarShadowRectBuffer, 20.0f, 20.0f, this.mShadowPaint);
                    } else {
        ...
        while (i6 < barBuffer.size()) {
            ...
            if (!this.mViewPortHandler.isInBoundsLeft(barBuffer.buffer[i7])) {
                ...
                if (z2) {
                    i2 = i5;
                    i3 = i6;
                    dataSet.getFill(i5).fillRect(c2, this.mRenderPaint, barBuffer.buffer[i6], barBuffer.buffer[i6 + 1], barBuffer.buffer[i7], barBuffer.buffer[i6 + 3], zIsInverted ? Fill.Direction.DOWN : Fill.Direction.UP);
                } else {
                    i2 = i5;
                    i3 = i6;
                    if (Constant.isHeGe() && this.isRoundBar) {
                        c2.drawRoundRect(barBuffer.buffer[i3], barBuffer.buffer[i3 + 1], barBuffer.buffer[i7], barBuffer.buffer[i3 + 3], 20.0f, 20.0f, this.mRenderPaint);
                    } else {
                        c2.drawRect(barBuffer.buffer[i3], barBuffer.buffer[i3 + 1], barBuffer.buffer[i7], barBuffer.buffer[i3 + 3], this.mRenderPaint);
                    }
                }
                if (z) {
                    c2.drawRect(barBuffer.buffer[i3], barBuffer.buffer[i3 + 1], barBuffer.buffer[i7], barBuffer.buffer[i3 + 3], this.mBarBorderPaint);
                }
            }
            i6 = i3 + 4;
            i5 = i2 + 1;
    ...
    */
    public void drawHighlighted(android.graphics.Canvas r15, com.yucheng.smarthealthpro.customchart.highlight.Highlight[] r16) {
        ...
        Ld9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yucheng.smarthealthpro.customchart.renderer.BarChartRenderer.drawHighlighted(android.graphics.Canvas, com.yucheng.smarthealthpro.customchart.highlight.Highlight[]):void");
    }
