...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0006\u0010\u0017\u001a\u00020\u0018J\u000e\u0010\u0019\u001a\u00020\u00182\u0006\u0010\u001a\u001a\u00020\u001bR\u001b\u0010\u0004\u001a\u00020\u00058BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\b\u0010\t\u001a\u0004\b\u0006\u0010\u0007R\u001a\u0010\n\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\r0\f0\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u001d\u0010\u000e\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\r0\f0\u000f8F¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011R\u001a\u0010\u0012\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00140\u00130\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u001d\u0010\u0015\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00140\u00130\u000f8F¢\u0006\u0006\u001a\u0004\b\u0016\u0010\u0011¨\u0006\u001c"}, d2 = {"Lcom/yucheng/smarthealthpro/viewmodel/SportRecordViewModel;", "Landroidx/lifecycle/ViewModel;", "<init>", "()V", "sportRecordRepository", "Lcom/yucheng/smarthealthpro/repository/SportRecordRepository;", "getSportRecordRepository", "()Lcom/yucheng/smarthealthpro/repository/SportRecordRepository;", "sportRecordRepository$delegate", "Lkotlin/Lazy;", "_sportRecordDataFlow", "Lkotlinx/coroutines/flow/MutableSharedFlow;", "Lcom/yucheng/smarthealthpro/data/packed/HealthDayData;", "Lcom/yucheng/smarthealthpro/database/room/bean/SportRecord;", "sportRecordDataFlow", "Lkotlinx/coroutines/flow/SharedFlow;", "getSportRecordDataFlow", "()Lkotlinx/coroutines/flow/SharedFlow;", "_deleteResultFlow", "Lkotlin/Result;", "", "deleteResultFlow", "getDeleteResultFlow", "getAllData", "", "deleteSportRecord", "startTimestamp", "", "app_SmartHealthRelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class SportRecordViewModel extends ViewModel {
    ...
    private final Lazy sportRecordRepository = LazyKt.lazy(new Function0() { // from class: com.yucheng.smarthealthpro.viewmodel.SportRecordViewModel$$ExternalSyntheticLambda0
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return SportRecordViewModel.sportRecordRepository_delegate$lambda$0();
        }
    });
    ...
    @DebugMetadata(c = "com.yucheng.smarthealthpro.viewmodel.SportRecordViewModel$getAllData$1", f = "SportRecordViewModel.kt", i = {}, l = {41, 42}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.yucheng.smarthealthpro.viewmodel.SportRecordViewModel$getAllData$1, reason: invalid class name and case insensitive filesystem */
    static final class C03591 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SportRecordViewModel.this.new C03591(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i2 == 0) {
                ...
                SportRecordRepository sportRecordRepository = SportRecordViewModel.this.getSportRecordRepository();
            ...
            List list = (List) obj;
            this.label = 2;
            if (SportRecordViewModel.this._sportRecordDataFlow.emit(new HealthDayData("", null, list, 2, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        }
    ...
    public final void getAllData() {
        BuildersKt__Builders_commonKt.launch$default(ViewModelKt.getViewModelScope(this), null, null, new C03591(null), 3, null);
    }

    /* compiled from: SportRecordViewModel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "com.yucheng.smarthealthpro.viewmodel.SportRecordViewModel$deleteSportRecord$1", f = "SportRecordViewModel.kt", i = {}, l = {51, 52}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.yucheng.smarthealthpro.viewmodel.SportRecordViewModel$deleteSportRecord$1, reason: invalid class name */
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SportRecordViewModel.this.new AnonymousClass1(this.$startTimestamp, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            MutableSharedFlow mutableSharedFlow = SportRecordViewModel.this._deleteResultFlow;
