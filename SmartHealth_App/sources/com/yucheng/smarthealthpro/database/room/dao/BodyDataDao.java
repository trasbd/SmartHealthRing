...
public interface BodyDataDao {
    ...
    Object getById(long j2, Continuation<? super BodyData> continuation);

    Object getByStartTimestamp(long j2, Continuation<? super List<BodyData>> continuation);

    Object getByUser(String str, Continuation<? super List<BodyData>> continuation);

    Object getByUserId(String str, Continuation<? super List<BodyData>> continuation);

    Object getDataInTimeRange(long j2, long j3, String str, Continuation<? super List<BodyData>> continuation);

    Object insert(BodyData bodyData, Continuation<? super Long> continuation);

    Object insertAll(List<BodyData> list, Continuation<? super List<Long>> continuation);

    Object markAsSynced(List<Long> list, boolean z, Continuation<? super Integer> continuation);

    Object queryAll(String str, Continuation<? super List<BodyData>> continuation);

    Object queryByYearToDay(String str, String str2, Continuation<? super List<BodyData>> continuation);

    Object querySinceYearToDay(String str, String str2, Continuation<? super List<BodyData>> continuation);

    Object querySyncedWithYearToDay(String str, String str2, boolean z, Continuation<? super List<BodyData>> continuation);

    Object update(BodyData bodyData, Continuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ Object markAsSynced$default(BodyDataDao bodyDataDao, List list, boolean z, Continuation continuation, int i2, Object obj) {
            if (obj != null) {
            ...
            return bodyDataDao.markAsSynced(list, z, continuation);
        }
    }
}
