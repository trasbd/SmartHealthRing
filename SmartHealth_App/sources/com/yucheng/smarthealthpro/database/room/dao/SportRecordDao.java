...
public interface SportRecordDao {
    ...
    Object deleteByStartTimestamp(long j2, String str, Continuation<? super Integer> continuation);

    Object getById(long j2, Continuation<? super SportRecord> continuation);

    Object getByStartTimestamp(long j2, Continuation<? super List<SportRecord>> continuation);

    Object getByUser(String str, Continuation<? super List<SportRecord>> continuation);

    Object getByUserId(String str, Continuation<? super List<SportRecord>> continuation);

    Object getDataInTimeRange(long j2, long j3, String str, Continuation<? super List<SportRecord>> continuation);

    Object insert(SportRecord sportRecord, Continuation<? super Long> continuation);

    Object insertAll(List<SportRecord> list, Continuation<? super List<Long>> continuation);

    Object queryAll(String str, Continuation<? super List<SportRecord>> continuation);

    Object queryByYearToDay(String str, String str2, Continuation<? super List<SportRecord>> continuation);

    Object querySinceYearToDay(String str, String str2, Continuation<? super List<SportRecord>> continuation);

    Object update(SportRecord sportRecord, Continuation<? super Unit> continuation);
