...
public interface UricAcidDao {
    ...
    Object getById(long j2, Continuation<? super UricAcid> continuation);

    Object getByStartTimestamp(long j2, Continuation<? super List<UricAcid>> continuation);

    Object getByUser(String str, Continuation<? super List<UricAcid>> continuation);

    Object getByUserId(String str, Continuation<? super List<UricAcid>> continuation);

    Object getDataInTimeRange(long j2, long j3, String str, Continuation<? super List<UricAcid>> continuation);

    Object insert(UricAcid uricAcid, Continuation<? super Long> continuation);

    Object insertAll(List<UricAcid> list, Continuation<? super List<Long>> continuation);

    Object markAsSynced(List<Long> list, boolean z, Continuation<? super Integer> continuation);

    Object queryAll(String str, Continuation<? super List<UricAcid>> continuation);

    Object queryByYearToDay(String str, String str2, Continuation<? super List<UricAcid>> continuation);

    Object querySinceYearToDay(String str, String str2, Continuation<? super List<UricAcid>> continuation);

    Object querySyncedWithYearToDay(String str, String str2, boolean z, Continuation<? super List<UricAcid>> continuation);

    Object update(UricAcid uricAcid, Continuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ Object markAsSynced$default(UricAcidDao uricAcidDao, List list, boolean z, Continuation continuation, int i2, Object obj) {
            if (obj != null) {
            ...
            return uricAcidDao.markAsSynced(list, z, continuation);
        }
    }
}
