...
public interface BloodKetonesDao {
    ...
    Object getById(long j2, Continuation<? super BloodKetones> continuation);

    Object getByStartTimestamp(long j2, Continuation<? super List<BloodKetones>> continuation);

    Object getByUser(String str, Continuation<? super List<BloodKetones>> continuation);

    Object getByUserId(String str, Continuation<? super List<BloodKetones>> continuation);

    Object getDataInTimeRange(long j2, long j3, String str, Continuation<? super List<BloodKetones>> continuation);

    Object insert(BloodKetones bloodKetones, Continuation<? super Long> continuation);

    Object insertAll(List<BloodKetones> list, Continuation<? super List<Long>> continuation);

    Object markAsSynced(List<Long> list, boolean z, Continuation<? super Integer> continuation);

    Object queryAll(String str, Continuation<? super List<BloodKetones>> continuation);

    Object queryByYearToDay(String str, String str2, Continuation<? super List<BloodKetones>> continuation);

    Object querySinceYearToDay(String str, String str2, Continuation<? super List<BloodKetones>> continuation);

    Object querySyncedWithYearToDay(String str, String str2, boolean z, Continuation<? super List<BloodKetones>> continuation);

    Object update(BloodKetones bloodKetones, Continuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ Object markAsSynced$default(BloodKetonesDao bloodKetonesDao, List list, boolean z, Continuation continuation, int i2, Object obj) {
            if (obj != null) {
            ...
            return bloodKetonesDao.markAsSynced(list, z, continuation);
        }
    }
}
