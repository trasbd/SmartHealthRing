...
public class HeartRateHisListAdapter extends BaseQuickAdapter<TemperatureHisListBean, BaseViewHolder> {
    ...
    public HeartRateHisListAdapter(int layoutResId) {
        super(layoutResId);
    ...
    public void convert(BaseViewHolder holder, final TemperatureHisListBean hisSearch) throws NumberFormatException {
        ...
        if (hisSearch != null) {
            holder.setText(R.id.tv_time, hisSearch.getTime()).setText(R.id.tv_value, ((int) Math.ceil(Double.parseDouble(hisSearch.getmValue()))) + "").setText(R.id.tv_unit, "bpm");
            try {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.yucheng.smarthealthpro.home.activity.heartrate.adapter.HeartRateHisListAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                if (HeartRateHisListAdapter.this.mOnItemClickListener != null) {
                    HeartRateHisListAdapter.this.mOnItemClickListener.onClick(hisSearch, layoutPosition);
                }
            }
        });
    }
