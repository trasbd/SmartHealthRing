...
public class KetoneMeasureActivity extends BaseMeasureActivity<ActivityBoMeasureBinding> {
    ...
    public static void load(Activity activity) {
        activity.startActivityForResult(new Intent(activity, (Class<?>) KetoneMeasureActivity.class), URICACID_MEASURE);
    }
