...
public class BloodFatTabFragment extends BaseLazyLoadFragment<FragmentTemptabBinding> {
    ...
    public static BloodFatTabFragment newInstance(String mTitles, int position, NestedScrollView mNestedScrollView, List<TemperatureHisListBean> mDayBloodOxygenHisListBean, List<TemperatureHisListBean> mWeekSumUpBloodOxygenHisListBean, List<TemperatureHisListBean> mMonthSumUpBloodOxygenHisListBean, float mMaxStepNum) {
        BloodFatTabFragment bloodFatTabFragment = new BloodFatTabFragment();
        bloodFatTabFragment.mTitles = mTitles;
        bloodFatTabFragment.position = Integer.valueOf(position);
        bloodFatTabFragment.mNestedScrollView = mNestedScrollView;
        bloodFatTabFragment.mDayBloodOxygenHisListBean = mDayBloodOxygenHisListBean;
        bloodFatTabFragment.mWeekSumUpBloodOxygenHisListBean = mWeekSumUpBloodOxygenHisListBean;
        bloodFatTabFragment.mMonthSumUpBloodOxygenHisListBean = mMonthSumUpBloodOxygenHisListBean;
        bloodFatTabFragment.mMaxStepNum = mMaxStepNum;
        return bloodFatTabFragment;
    }
    ...
    protected void lazyLoadData() throws NumberFormatException {
        if (this.mTitles.equals(getString(R.string.date_month_unit))) {
            ...
            TempLineChartUtils.initLineChart(this.mTempMonthChart, this.context, this.mMonthSumUpBloodOxygenHisListBean, this.mToDay, this.mNestedScrollView, TempLineChartUtils.FUNCTION.BLOODFAT, this.yMaximum, this.yMinimum, this.xMonthMaximum, this.mMonthXLabelCount, this.mMonthYLabelCount, TempLineChartUtils.FORMATTER.MONTH);
            return;
        }
        if (this.mTitles.equals(getString(R.string.date_week_unit))) {
            ...
            TempLineChartUtils.initLineChart(this.mTempWeekChart, this.context, this.mWeekSumUpBloodOxygenHisListBean, this.mToDay, this.mNestedScrollView, TempLineChartUtils.FUNCTION.BLOODFAT, this.yMaximum, this.yMinimum, this.xWeekMaximum, this.mWeekXLabelCount, this.mWeekYLabelCount, TempLineChartUtils.FORMATTER.WEEK);
            return;
        }
        this.mTempDayChart.setVisibility(0);
        this.mTempWeekChart.setVisibility(8);
        this.mTempMonthChart.setVisibility(8);
        TempLineChartUtils.initLineChart(this.mTempDayChart, this.context, this.mDayBloodOxygenHisListBean, this.mToDay, this.mNestedScrollView, TempLineChartUtils.FUNCTION.BLOODFAT, this.yMaximum, this.yMinimum, this.xDayMaximum, this.mDayXLabelCount, this.mDayYLabelCount, TempLineChartUtils.FORMATTER.DAY);
    }
}
