...
import com.yucheng.smarthealthpro.databinding.ActivityAiDiagnosisNewBinding;
...
public class EcgAiDiagnoseNewActivity extends BaseVbActivity<ActivityAiDiagnosisNewBinding> implements CancelAdapt {
    ...
    private void initView() {
        this.tvDiagnosis = ((ActivityAiDiagnosisNewBinding) this.mBinding).includeDiagnoseHeader.tvDiagnosis;
        this.tvHRVValue = ((ActivityAiDiagnosisNewBinding) this.mBinding).includeDiagnoseHeader.tvHRVValue;
        this.tvDetails = ((ActivityAiDiagnosisNewBinding) this.mBinding).includeDiagnoseHeader.tvDetail;
        this.tvAgeValue = ((ActivityAiDiagnosisNewBinding) this.mBinding).includeDiagnoseHeader.tvAgeValue;
        this.tvGenValue = ((ActivityAiDiagnosisNewBinding) this.mBinding).includeDiagnoseHeader.tvGenValue;
        this.tvBPValue = ((ActivityAiDiagnosisNewBinding) this.mBinding).includeDiagnoseHeader.tvBPValue;
        this.tvDetailTag = ((ActivityAiDiagnosisNewBinding) this.mBinding).includeDiagnoseHeader.tvDetailTag;
        this.ivAiDiagnosisEcg = ((ActivityAiDiagnosisNewBinding) this.mBinding).ivAiDiagnosisEcg;
        this.mRecyclerView = ((ActivityAiDiagnosisNewBinding) this.mBinding).recycleView;
        this.aiDiagnosisInDoubt = ((ActivityAiDiagnosisNewBinding) this.mBinding).aiDiagnosisInDoubt;
        this.tv_title = ((ActivityAiDiagnosisNewBinding) this.mBinding).aiDiagnosisDetailTitleTv;
        this.dataRecyclerView = ((ActivityAiDiagnosisNewBinding) this.mBinding).dataRecyclerView;
    ...
    private void initViewModel() {
        ...
        FlowUtils.INSTANCE.collectFlow(this, this.mViewModel.getHistoryEcgResultFlow(), new FlowUtils.FlowCollector<HealthResult<List<EcgMeasure>>>() { // from class: com.yucheng.smarthealthpro.home.activity.ecg.activity.EcgAiDiagnoseNewActivity.1
            @Override // com.yucheng.smarthealthpro.utils.FlowUtils.FlowCollector
            public void collect(HealthResult<List<EcgMeasure>> result) {
                EcgAiDiagnoseNewActivity.this.onFindEcgHistory(result.getValue());
            }
        });
    }
    ...
    public void onFindEcgHistory(List<EcgMeasure> data) {
        if (data != null && data.size() > 0) {
            this.mEcgMeasureList = (List) this.mGson.fromJson(data.get(0).getMeasureData(), new TypeToken<List<Integer>>() { // from class: com.yucheng.smarthealthpro.home.activity.ecg.activity.EcgAiDiagnoseNewActivity.2
            }.getType());
        }
    ...
    private void addBean() {
        String str = "https://staticpage.ycaviation.com/project/ECG_WEB/#/show/%s/?lang=" + MultiLanguageUtils.getLanguageStr(this.context);
        ...
        ecgAiDiagnoseItemBean.setUrl(String.format(str, "af"));
        ...
        ecgAiDiagnoseItemBean2.setUrl(String.format(str, "vf"));
        ...
        ecgAiDiagnoseItemBean3.setUrl(String.format(str, "ae"));
        ...
        ecgAiDiagnoseItemBean4.setUrl(String.format(str, "apb"));
        ...
        ecgAiDiagnoseItemBean5.setUrl(String.format(str, "pvb"));
        ...
        ecgAiDiagnoseItemBean6.setUrl(String.format(str, "ve"));
        ...
        ecgAiDiagnoseItemBean7.setUrl(String.format(str, "jpb"));
        ...
        ecgAiDiagnoseItemBean8.setUrl(String.format(str, "jes"));
        ...
        ecgAiDiagnoseItemBean9.setUrl(String.format(str, "lbbb"));
        ...
        ecgAiDiagnoseItemBean10.setUrl(String.format(str, "rbbb"));
    ...
    private void setDataRecyclerView() {
        ...
        this.ecgDataAdapter.setOnItemClickListener(new OnItemClickListener() { // from class: com.yucheng.smarthealthpro.home.activity.ecg.activity.EcgAiDiagnoseNewActivity$$ExternalSyntheticLambda0
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (bitmap != null) {
            ...
            this.ivAiDiagnosisEcg.setOnClickListener(new View.OnClickListener() { // from class: com.yucheng.smarthealthpro.home.activity.ecg.activity.EcgAiDiagnoseNewActivity.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    ImageViewUtil.getInstance(EcgAiDiagnoseNewActivity.this.mBitmap);
                    EcgAiDiagnoseNewActivity.this.startActivity(new Intent(EcgAiDiagnoseNewActivity.this.context, (Class<?>) AIResultImageActivity.class));
                }
            });
        }
    }
    ...
    public void aiLogin() {
        new OkHttpClient.Builder().connectTimeout(10L, TimeUnit.SECONDS).readTimeout(10L, TimeUnit.SECONDS).build().newCall(new Request.Builder().url(Constants.AiLogin).addHeader(HttpHeaders.CONTENT_TYPE, "application/json").post(new FormBody.Builder().add("merchant_name", "szyc0808").add("merchant_password", "c3p5YzA4MDg=").build()).build()).enqueue(new Callback() { // from class: com.yucheng.smarthealthpro.home.activity.ecg.activity.EcgAiDiagnoseNewActivity.4
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                EcgAiDiagnoseNewActivity.this.runOnUiThread(new Runnable() { // from class: com.yucheng.smarthealthpro.home.activity.ecg.activity.EcgAiDiagnoseNewActivity.4.1
                    @Override // java.lang.Runnable
                    public void run() throws NumberFormatException {
                        try {
                            if (new JSONObject(strString).getInt("code") == 200) {
                                EcgAiDiagnoseNewActivity.this.testzd();
                            } else {
                                Tools.showAlert3(EcgAiDiagnoseNewActivity.this.context, "数据错误");
                            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    if (jSONObject2.getInt("code") == 200) {
                        EcgAiDiagnoseNewActivity.this.go2WebActivity(jSONObject2);
                    }
    ...
    private void setRecycleView() {
        ...
        ecgAiDiagnoseAdapter.setOnItemClickListener(new EcgAiDiagnoseAdapter.OnItemClickListener() { // from class: com.yucheng.smarthealthpro.home.activity.ecg.activity.EcgAiDiagnoseNewActivity.7
            ...
            public void onClick(EcgAiDiagnoseItemBean hisSearch, int position) {
                Intent intent = new Intent(EcgAiDiagnoseNewActivity.this, (Class<?>) AiWebActivity.class);
                intent.putExtra("title", ((EcgAiDiagnoseItemBean) EcgAiDiagnoseNewActivity.this.lists.get(position)).getType().split(":")[0]);
                intent.putExtra("url", ((EcgAiDiagnoseItemBean) EcgAiDiagnoseNewActivity.this.lists.get(position)).getUrl());
                EcgAiDiagnoseNewActivity.this.startActivity(intent);
            }
        });
    }
